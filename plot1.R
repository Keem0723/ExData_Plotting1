...
# PNG Plot 1: Histogram of Global Active Power (kilowatts)
png("plot1.png",width = 480,height = 480) #Launching PNG graphic device

hist(dt0$Global_active_power, col = "red", xlab = "Global Active Power (kilowatts)", main = "Global Active Power") #Creating the historgram according to specification
